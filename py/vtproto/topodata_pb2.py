...
_SHARD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='main_alias', full_name='topodata.Shard.main_alias', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_main_serving', full_name='topodata.Shard.is_main_serving', index=5,
...
_SHARD.fields_by_name['main_alias'].message_type = _TABLETALIAS
