...
primary key (name)
  ...
  def _check_startup_values(self):
    ...
    self._check_value(shard_2_main, 'resharding1', 3, 'msg3',
    ...
    self._check_value(shard_2_replica2, 'resharding1', 3, 'msg3',
                      0xD000000000000000, should_be_here=False)
    self._check_value(shard_3_main, 'resharding1', 3, 'msg3',
                      0xD000000000000000)
  ...
  def test_resharding(self):
    ...
    self.check_running_binlog_player(shard_2_main, 4000, 2000)
    self.check_running_binlog_player(shard_3_main, 4000, 2000)
    ...
    # then serve main from the split shards, make sure the source main's
