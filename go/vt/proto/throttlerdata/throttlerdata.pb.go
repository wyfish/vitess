...
type Configuration struct {
	...
	// we guessed the rate of a subordinate and determined its backlog.
	...
	// will take the subordinate to go through the backlog (in addition to new
