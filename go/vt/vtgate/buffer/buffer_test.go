...
func TestBuffer(t *testing.T) {
	...
	// Simulate that the current main reports its ExternallyReparentedTimestamp.
...
func TestLastReparentTooRecent_BufferingSkipped(t *testing.T) {
	...
	// Simulate that the old main notified us about its reparented timestamp
	...
	// Failover to new main. Its end is detected faster than the beginning.
...
func TestLastReparentTooRecent_Buffering(t *testing.T) {
	...
	// Failover to new main. Do not issue any requests before or after i.e.
